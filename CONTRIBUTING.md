...
This project contains both schema and Go code. Some of that go, specifically the contents of [generated_types.go](generated_types.go) is generated by `make cuegen` based on the `cue` schema contents in [schemas/](/schemas).
